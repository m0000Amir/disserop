...
---
 ...
 - [ ] Заменить слова Построены в научной новизне.
 - [ ] Разработку программного комплекса опустить в конец списка.
 - [ ] Исправить все грамматические и орфографические ошибки в диссертации.
 - [ ] Переделать актуальность в отзыве внешнего специалиста.
 - [ ] Переделать вторую страницу в автореферате (посмотреть на странице Физтеха).

## 21 апреля 2022г.
- [x] сверить автореферат с отзывом Самуйлова;
- [ ] проверить текст на странице 72;
- [ ] проверить условие существования допустимого решения;
  
## 27 апреля 2022г.
- [ ] переделать описание глав;
- [ ] в третьей главе написать, что задача минимизация стоимости.
- [ ] в противном случае обособляется (запятые)
- [ ] в формулах точки
