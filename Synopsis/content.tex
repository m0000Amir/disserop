...
Одним из важнейших объектов нефтегазового сектора являются магистральные трубопропроводы. Неотъемлемой частью повышения эффективности эксплуатации трубопроводов является поддердание рабочего состояния линейных участков. Одними из основных причин неисчислимых потерь и загрязняния окружающей среды в трубопроводных сетях являются утечки \cite{Adegboye2019} 

Здесь появляется еще одна научно-техническая проблема -- организация соверменной телекоммуникационной системы контроля и мониторинга состояния трубопроводов. На сегодняшний день с этой задачей уверенно справляются беспроводные сенсорные сети. Как было замечено ранее, к сожалению, устаревшие протоколы уже не в силах удовлетворить все необходимые потребности современного производства. 
