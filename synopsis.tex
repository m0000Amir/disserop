...
\input{common/styles}         % Стили оcбщие для диссертации и автореферата
...
\small
\begin{center}
    \textit{Научное издание} \par \medskip \medskip \medskip
    \textbf{\thesisAuthor}
    \par\medskip
    ...
    \bigskip
    АВТОРЕФЕРАТ \par
    дисcертации на соискание ученой степени \par
    кандидата технических наук
    \par\bigskip


    Подписано в печать 04.07.2022 \par
    Формат 60\(\times\)90/16. Усл. печ. л. 1,56. Уч.-изд. л. 1,0 \par
    Тираж 100 экз.  Заказ № 121
    %Это не совсем формат А5, но наиболее близкий, подробнее: http://ru.wikipedia.org/w/index.php?oldid=78976454
    \par\bigskip
    Федеральное государственное бюджетное учреждение науки \par
    \textbf{Институт проблем управления им. В.А. Трапезникова} \par
    Российской академии наук  \par
    117997,  \par
    ул. Профсоюзная, д. 65  \par
    Россия, Москва  \par
    http://www.ipu.ru
