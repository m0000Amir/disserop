...
\begin{frame}
    ...
    % \hfill  
    \begin{minipage}[c]{0.47\linewidth}
        \center{\includegraphics[scale=0.42]{bsp_input_data.png}}
...
\begin{frame}
    ...
    \fontsize{8pt}{7.2}\selectfont
    \justifying
    Задача ЦЛП (24) - (29) решалась в пакете Gurobi Optimizer.

    \begin{minipage}[c]{0.45\linewidth}
        \fontsize{8pt}{7.2}\selectfont
        \bigskip
        \includegraphics[scale=0.33]{bsp_input_data.png}
    ...
    % \hfill  
    \begin{minipage}[c]{0.45\linewidth}
        \includegraphics[scale=0.35]{bsp_solution.png}
